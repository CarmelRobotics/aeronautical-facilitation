...
public class RobotDrive6 implements MotorSafety, IUtility {
    ...
    public void mecanumDrive_Cartesian(double x, double y, double rotation, double gyroAngle)
    {
        ...
        m_middleLeftMotor.set(wheelSpeeds[MotorType.kRearRight_val] * m_invertedMotors[MotorType.kRearRight_val] * m_maxOutput, syncGroup);
        m_middleRightMotor.set(wheelSpeeds[MotorType.kRearRight_val] * m_invertedMotors[MotorType.kRearRight_val] * m_maxOutput, syncGroup);
